...
if __name__ == '__main__':
    ...
    trainer = Trainer(args.schema)
    if args.infer_image is None:
        trainer.train(args)
    else:
        trainer.infer(image_source=args.infer_image, ckpt_location=args.ckpt, device=args.device, image_size=args.img_size, verbose=args.verbose, beam_width=args.beam_width, topn=args.topn, capture_live_dir=args.capture_live_dir)
